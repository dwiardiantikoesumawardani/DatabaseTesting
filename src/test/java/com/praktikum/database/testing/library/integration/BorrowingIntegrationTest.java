...
public class BorrowingIntegrationTest extends BaseDatabaseTest {
    ...
    void testMultipleBorrowings_BySameUser_ShouldSuccess() throws SQLException {
        ...
        Borrowing borrowing1 = borrowingService.borrowBook(testUser.getUserId(), testBook.getBookId(), 7);
    ...
    void testFineCalculation_ForOverdueBooks() throws SQLException, InterruptedException {
        ...
        Timestamp borrowDate = Timestamp.valueOf(LocalDateTime.now().minusDays(2)); // Borrowing 2 hari lalu
        Timestamp pastDueDate = Timestamp.valueOf(LocalDateTime.now().minusDays(1)); // Due date 1 hari lalu
